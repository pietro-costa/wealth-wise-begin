...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-primary-foreground hover:shadow-elegant hover:scale-[1.02] transition-all duration-300",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:shadow-lg transition-all duration-300",
        outline:
          "border border-border bg-background hover:bg-accent/10 hover:text-accent-foreground hover:border-accent transition-all duration-300",
        secondary:
        ...
        gradient: "bg-gradient-accent text-accent-foreground hover:shadow-glow hover:scale-[1.02] transition-all duration-300",
        premium: "bg-gradient-primary border border-primary/20 text-primary-foreground hover:shadow-glow hover:scale-[1.02] animate-glow transition-all duration-300",
      },
      size: {
